...
public class NumeriPergamene {
	...
	public int getPergameneTrovate() {
		return nPergameneTrovate;
	}
	public void setPergameneTrovate(int nPergameneTrovate) {
		this.nPergameneTrovate = nPergameneTrovate;
	}
...
//		}
	...
	public Group getView() {
		...
		ImageView pergamena=new ImageView(selezionaImmagine());
		pergamena.setFitWidth(100);
		pergamena.setFitHeight(100);
		nPergamene.setLayoutY(40);
		gruppo.getChildren().addAll(pergamena, nPergamene);
		return gruppo;
	}
}
